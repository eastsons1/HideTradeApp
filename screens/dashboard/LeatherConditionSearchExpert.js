...
const LeatherConditionSearchExpert = (props) => {
  ...
  const renderCondition = ({ item, index }) => {
    console.log(item, "LLLLLLLLLLLLLLLLLLLLLLLLLLLL");
    const { id, title, image_name } = item;
    const isSelected = selected.filter((i) => i === title).length > 0;

    console.log(isSelected, "KKKKKKKKKKKKKKKKKKKKKK");
        ...
        <View style={{ flex: 1 }}>
          <ScrollView>
            <View style={{ marginHorizontal: 15 }}>
              ...
              >
                For which leather condition do you need the expert?
              </Text>
              <View>
            ...
            <View style={{ flexDirection: "row", marginBottom: 15 }}>
              ...
              >
                <TouchableOpacity
                  ...
                  onPress={() =>
                    //props.navigation.navigate("TanningLeatherSearchExpert",{leather_conditions:selected})
                    props.navigation.navigate("Kind Of Leather", {
                      leather_conditions: selected,
                    })
                  }
                >
                  <Text
...
export default LeatherConditionSearchExpert;
